...
@Singleton
class CustomerUpdateUseCase @Inject constructor(private val repository: CustomerRepository) {
	operator fun invoke(customer: Customer): Flow<ResponseResult<Customer>> = repository.update(customer)
}